...
export default function HomePage() {
  return <div className="clinical"><SiteHeader /><main id="main-content" className="clinical-wrap">
    ...
    <FounderNote />
    <div className="resource-grid"><Link href="/science"><span className="clinical-eyebrow">01 / Go deeper</span><h3>The research framework</h3><p>Explore the oral-vascular-neural axis and the hypotheses driving the next questions.</p><ArrowUpRight size={19} aria-hidden="true" /></Link><Link href="/education"><span className="clinical-eyebrow">02 / Keep learning</span><h3>Clinical education</h3><p>Build your understanding through modules on oral-systemic science.</p><ArrowUpRight size={19} aria-hidden="true" /></Link><Link href="/blog"><span className="clinical-eyebrow">03 / Follow the field</span><h3>The Oral Health Bulletin</h3><p>Read perspectives on the research and the questions it raises for practice.</p><ArrowUpRight size={19} aria-hidden="true" /></Link><a href="https://ledger.gengyveusa.com" target="_blank" rel="noopener noreferrer"><span className="clinical-eyebrow">04 / Run the numbers</span><h3>The Practice Ledger</h3><p>The weekly briefing on the business of dentistry: practice economics, DSO intelligence, and the Bench Test scorecard on dental AI tools.</p><ArrowUpRight size={19} aria-hidden="true" /><span className="sr-only"> (opens in a new tab)</span></a></div>
